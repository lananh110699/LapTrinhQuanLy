...
namespace NTLABaiTapThucHanh613.Areas.Admin.Controllers
{
    public class NCCsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaNCC,TenNCC,TenHang,DiaChi,SDT")] NCC nCC)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaNCC,TenNCC,TenHang,DiaChi,SDT")] NCC nCC)
        {
            if (ModelState.IsValid)
            {
